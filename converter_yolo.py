...
train_annotations_bbox = pd.read_csv('OID/csv_folder/train-annotations-bbox.csv')

# load classes csv file
class_descriptions_boxable = pd.read_csv('OID/csv_folder/class-descriptions-boxable.csv')
